<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <!-- Profile -->
        <div class="mt-4">
            <x-input-label for="profile" :value="__('Company Description')" />
            <textarea id="profile" class="block mt-1 w-full" name="profile" cols="30" rows="10" required autofocus autocomplete="profile">{{old('profile')}}</textarea>
